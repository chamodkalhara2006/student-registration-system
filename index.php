...
if(isset($_POST['submit'])){
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO student_data(u_card, u_f_name, u_l_name, u_birthday, u_gender, u_email, u_phone,image,uploaded) VALUES ('$u_card','$u_f_name','$u_l_name','$u_birthday','$u_gender','$u_email','$u_phone','$image',NOW())";
...
?>
	...
	<a href="logout.php" class="btn"><i class="fa fa-lock"></i> Logout</a>
	<button class="btn " type="button" data-toggle="modal" data-target="#myModal">
  <i class="fa fa-plus"></i> Add New Student
  </button>
  <a href="export.php" class="btn pull-right"><i class="fa fa-download"></i> Export Data</a>
  <hr>
		...
		<thead>
        	...
        	while($row = mysqli_fetch_array($run_data))
        	{
				...
				<td class='text-center'>
					<span>
					<a href='#' class='btn mr-3 profile' data-toggle='modal' data-target='#view$id' title='Prfile'><i class='fa fa-address-card-o' aria-hidden='true'></i></a>
					</span>
					
				</td>
				<td class='text-center'>
					<span>
					<a href='#' class='btn mr-3 edituser' data-toggle='modal' data-target='#edit$id' title='Edit'><i class='fa fa-pencil-square-o fa-lg'></i></a>
				...
				<td class='text-center'>
					<span>
						...
						<a href='#' class='btn deleteuser' title='Delete'>
     ...
     <input type="submit" name="export" class="btn" value="Export Data" />
    </form>
	</div>
